...
#generate the data without the first image of each eye
def load_data_withouthead(x_size,y_size,data_path,label_path,image_s_path,uncentain_path,validation_name,test_name):
